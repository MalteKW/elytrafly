...
object LuckpermsSettingsProvider : SettingsProvider {
    ...
    override fun boostDelay(player: Player): Int {
        ...
        val metavalue =
            API.getPlayerAdapter(Player::class.java).getMetaData(player).getMetaValue("elytrafly.boost-delay")
    ...
    override fun maxBoosts(player: Player): Int {
        ...
        val metavalue =
            API.getPlayerAdapter(Player::class.java).getMetaData(player).getMetaValue("elytrafly.max-boosts")
